...
export default class WorkflowSettings extends React.Component {
  pages = [
    {
      route: 'general',
      label: <FormattedMessage id="ui-workflow.settings.general" />,
      component: GeneralSettings,
    },
    {
      route: 'somefeature',
      label: <FormattedMessage id="ui-workflow.settings.some-feature" />,
  ...
  render() {
    return (
      <Settings {...this.props} pages={this.pages} paneTitle="UI Workflow" />
    );
  }
}
