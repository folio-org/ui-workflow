...
import { useBrowseSearchPaneFilter, useFilters, useSearch } from '../../../hooks';
 ...
 */
export const BrowseSearchPane: React.FC<IListProperties> = ({ filterConfig, list, view }) => {
  ...
  }, [ browsePane, filters.appliedFilters, search.value, search.index ]);
